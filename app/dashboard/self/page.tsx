  ...
  return (
    <div className="space-y-5">
      ...
      {tab === 'progress' && (
        <div className="space-y-5">
          <div>
            <h2 className="text-xl font-bold text-stone-900 tracking-tight">Progress</h2>
            <p className="text-sm text-stone-400 mt-0.5">Track your completion across all time periods</p>
          </div>
